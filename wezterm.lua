...
wezterm.plugin.require("https://github.com/saltkid/bagman").setup({
    dirs = {
        os.getenv("HOME") .. "/pictures/wt_bg/center-uniform-0.1",
        os.getenv("HOME") .. "/pictures/wt_bg/center-uniformToFill-0.1",
        {
            path = os.getenv("HOME") .. "/pictures/wt_bg/right-uniform-0.1",
            horizontal_align = "Right",
        },
    },
    interval = 30 * 60,
    backdrop = colors.background,
    loop_on_startup = true,
